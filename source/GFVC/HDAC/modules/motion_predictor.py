...
from .train_utils import make_coordinate_grid, kp2gaussian, AntiAliasInterpolation2d
...
if __name__ == "__main__":
    ...
    macs, params = profile(motion_generator, inputs=(reference,kp_reference,kp_target))
