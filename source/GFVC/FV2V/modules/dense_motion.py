...
import torch
from GFVC.FV2V.modules.util import Hourglass, make_coordinate_grid, kp2gaussian

from GFVC.FV2V.sync_batchnorm import SynchronizedBatchNorm3d as BatchNorm3d
...
class DenseMotionNetwork(nn.Module):
    ...
    def create_deformed_feature(self, feature, sparse_motions):
        ...
        sparse_deformed = F.grid_sample(feature_repeat, sparse_motions,align_corners=True)
    ...
    def forward(self, feature, kp_driving, kp_source):
        ...
        deformation = deformation.permute(0, 2, 3, 4, 1)           # (bs, d, h, w, 3) torch.Size([bs, 16, 64, 64, 3])
        ...
        if self.occlusion:
            ...
            occlusion_map = torch.sigmoid(self.occlusion(prediction)) #torch.Size([bs, 1, 64, 64])
