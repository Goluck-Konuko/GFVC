...
def load_FOMM_checkpoints(config_path, checkpoint_path, cpu=False):
    if cpu:
        device = 'cpu'
    else:
        device = 'cuda'
...
def make_FOMM_prediction(reference_frame, kp_reference, kp_current, generator,relative=False, adapt_movement_scale=False, cpu=False):
